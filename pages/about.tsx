        ...
        <div className="lg:col-span-8 col-span-1">
          <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8 lg:rounded-sm">
            <div className="prose max-w-none">
              ...
              <p>
                So, I followed{' '}
                <Link href={'https://www.youtube.com/watch?v=HYv55DhgTuA'}>this here tutorial</Link>
                to build this site. Because, despite the fact that coding is my day job, I lack both
                the intellectual resources as well as the patience to learn how to do any of this by
                just reading documentation. So kudos to whoever made that tutorial - you're a
                legend.
              </p>
              <p>
                And so that brings us here. Most probably no one will see this, but I think that's
                half the fun.
              </p>
              <p>Enjoy your stay, I'll see ya around.</p>
            </div>
          </div>
        </div>
